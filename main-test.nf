...
process knead {
	...
	set sample_name, file("${sample_name}.fastq"), file("${sample_name}.R1.fq.kneaddata_paired_2.fastq") into next_ch
	...
	kneaddata --input ${fastq1} --reference-db examples/demo_db --output ./
	"""       
}
